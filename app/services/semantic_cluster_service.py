...
class SemanticClusterService:
    def cluster(
        ...
        # Step 1: High-Precision Database Token Matching
        ...
        if precision_records:
            ...
            # Step 2: Semantic Vector Fallback
            try:
        ...
        if settings.is_llm_configured:
            ...
            try:
                ...
                # Reconstruct clusters from LLM output
        ...
        # Save conversation state for follow-up execution prompts
